...
6. **VF-GRAD-1/2/3 (graduated assistance, NEW v4)** — confirm the proposals to (a) re-badge pediatric to grounded stabilize-transfer rather than a bare abstain, (b) close the N22 transfer-infeasible **dead-end** with grounded maximal-medical, and (c) lead N99 with grounded help. Draft SQL is in `../spine/edh-cgt.sql` §[VERIFY-MENTOR], **UNSIGNED / not active until you sign**. Where-to-cut (N40) stays a hard abstain. Also confirm anticoag→transfer remains the intended conservative default.
